...
class gnu_am_transmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GNU AM Transmitter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GNU AM Transmitter")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "gnu_am_transmitter")
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_1, 1))
...
def main(top_block_cls=gnu_am_transmitter, options=None):
